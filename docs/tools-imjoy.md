...
![imjoy-plugin-installation](img/imjoy-plugin-installation.png){: style="width:300px"}
...
![imjoy-workspace.gif](img/imjoy-workspace.gif){: style="width:500px"}
...
and engine, which can be installed via Miniconda (see installation instructions [below](#install-jupyter-engine-for-imjoy)). 
...
1. Launch a **Jupyter Engine for ImJoy**:
    ...
    2. **Activate the environment**: `conda activate rna-loc-liver`
...
```
conda create --name rna-loc-liver python=3.7
```
